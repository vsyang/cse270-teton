...
class TestSmokeTest():
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1219, 1055)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Vanessa")
    self.driver.find_element(By.NAME, "lname").send_keys("Yang")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Jinu House")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Mom")
